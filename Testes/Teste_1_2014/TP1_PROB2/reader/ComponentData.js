...
function ComponentData(id) {
	...
	//LAIGPROB2 - Start
	this.forcedMats = []; //indicates if the component forces its material to all its children, resp. for each material
	//LAIGPROB2 - End
};
...
//LAIGPROB2 - Start
/**
 * Checks if the active material is to be forced.
 */
ComponentData.prototype.isActiveMatForced = function()
{
	return this.forcedMats[this.activeMaterialId];
};
//LAIGPROB2 - End
...
//LAIGPROB2 - Start
/**
 * Sets the last material to be forced.
 */
ComponentData.prototype.setLastMaterialAsForced = function()
{
	var nMats = this.forcedMats.length;
	this.forcedMats[nMats - 1] = true;
};
//LAIGPROB2 - End