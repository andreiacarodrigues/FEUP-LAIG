 ...
 */
XMLscene.prototype.displayComponent = function (component, curMaterial, curTexture, forceMat) {
	this.pushMatrix();
	...
	if(!forceMat)
	{
		...
		else
		{
			...
			newForceMat = component.isActiveMatForced();
		}
	}
	else //force the material
	{
		var newMaterial = curMaterial;
	}
	...
	for(let i = 0; i < components.length; i++)
	{
		...
		this.displayComponent(newComponent,newMaterial,newTexture,newForceMat);
	}
...
XMLscene.prototype.display = function () {	
	...
	if (this.motorReady)
	{
		...
		//LAIGPROB2 - Start
		if(this.displayComponent(this.rootComponent, this.materialDefault, null, false) != null)
		//LAIGPROB2 - End
		{
