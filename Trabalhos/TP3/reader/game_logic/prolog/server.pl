...
parse_input(move1(Decision1,Line1-Col1,DestLine1-DestCol1),Status):-
	...
	% Set the status info
	getLastMove(NewGame,LastFirstMove-_),
	...
	Status = (LastFirstMove\MoveDeaths\AllValidAddToidNewGames\AllValidAddPincerNewGames\AllValidAddLegNewGames).
...
getMove2Status(NewGame,Status):-
	...
	getLastMove(NewGame,LastFirstMove-LastSecondMove),
	getMoveDeaths(NewGame,MoveDeaths),
	...
	Status = (Winner\LastFirstMove+LastSecondMove\MoveDeaths\Player1\Player2\AllValidMoves\HungryToids).
