...
ComponentsMap.prototype.areAllLoaded=function()
{
	...
	{
		if(this.isSpecialComponentName(key))
		{
			continue;
		}
...
/**
 * Checks if the component has a special name
 */
ComponentsMap.prototype.isSpecialComponentName= function(name)
{
	return ((name == "game_board") || (name=="game_scores"));
} 